...
import { IBotMessage } from "./interfaces/bot";
...
export class BotMessage implements IBotMessage {
  ...
  public setTimestamp(timestamp?: number | Date | undefined): IBotMessage {
    this.validateRichText().setTimestamp(timestamp);
    return this;
  }

  public setAuthor(name: any, icon?: string | undefined, url?: string | undefined): IBotMessage {
    this.validateRichText().setAuthor(name, icon, url);
    return this;
  }
